    ...
    "properties": {
        ...
        "citations": {
            ...
            "properties": {
                ...
                "liquidityTarget": {"type": "array", "items": {"type": "string"}},
                "retracement": {"type": "array", "items": {"type": "string"}},
                "entry": {"type": "array", "items": {"type": "string"}},
                "invalidation": {"type": "array", "items": {"type": "string"}},
                "tp1": {"type": "array", "items": {"type": "string"}},
                "tp2": {"type": "array", "items": {"type": "string"}},
