...
- Give each timestamp as a full UTC timestamp YYYY-MM-DDTHH:MM:SSZ when known; when only the date is known return just YYYY-MM-DD; never emit placeholder characters such as ?? inside a timestamp.
